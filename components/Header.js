...
const Header = () => {
  ...
  const notifyConnectWallet = () => toast.error("Connect wallet to view balance", { duration: 2000 });
          ...
          <ul className="items-stretch hidden space-x-3 lg:flex">
            <li className="flex">
              <a
                rel="noopener noreferrer"
                href="/"
                className="flex items-center px-4 -mb-1 dark:border-transaprent text-[#7765F3] border-[#7765F3]">
                Swap
              </a>
            </li>
            <li className="flex">
              <a
                rel="noopener noreferrer"
                href="/tokens"
                className="flex items-center px-4 -mb-1 dark:border-transaprent" >
                Tokens
              </a>
            </li>
            <li className="flex">
